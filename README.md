...
<h3 align="left">A simple yet powerful Java application that implements the <strong>Advanced Encryption Standard (AES)<strong> algorithm to perform secure text encryption and decryption.  
...
<h3 align="left"><strong>AES (Advanced Encryption Standard)<strong> is a symmetric encryption algorithm widely used for securing data.  
This project — <strong>EDcrypt</strong> — provides an educational and functional example of how AES can be implemented in Java using the built-in `javax.crypto` package.</h3>
